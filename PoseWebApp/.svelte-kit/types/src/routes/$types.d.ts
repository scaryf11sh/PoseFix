...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/account" | "/(app)/account/delete" | "/(app)/account/notifications" | "/(app)/account/password" | "/(app)/camera" | "/(app)/exercises" | "/(app)/exercises/[id]" | "/(app)/export" | "/(app)/gallery" | "/(app)/progress" | "/(app)/progress/[id]" | "/(app)/settings" | "/auth" | "/onboarding" | null
